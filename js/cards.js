...
const projectsData = [
  {
    title: "Memory Game 🍎",
    description:
      "Um jogo da memória interativo desenvolvido para desafiar a capacidade de memorização dos jogadores. O objetivo do jogo é encontrar pares de cartas idênticas em um tabuleiro.",
  ...
  },
  {
    title: "MilkMania 🍨",
    description:
      "Landing page do Milkmania apresenta a loja e seus produtos. Com um design simples e convidativo, destaca a variedade de opções e convida os clientes a conhecerem mais.",
  ...
  },
  {
    title: "Burger 🍔",
    description:
      "Uma landing page do Burger, criada para apresentar o restaurante e seus hambúrgueres. Com design atraente e funcional, destaca o cardápio e facilita a navegação para quem quer saber mais.",
    imageUrl: "./assets/projects/burger.png",
    skills: ["fa-brands fa-html5", "fa-brands fa-css3-alt", "fa-brands fa-js"],
    link: "https://theburger-place.vercel.app/",
  },
];
...
function createProjectCard(project) {
  ...
  card.innerHTML = `
        ...
        <div class="footer-card">
            <p><i class="fa-solid fa-arrow-up-right-from-square"></i>Acesse o site: <a href="${
              project.link
